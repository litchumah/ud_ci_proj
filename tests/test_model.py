...
def test_train_model(data):
    ...
    assert results.shape[0] == y_train.shape[0], f"The number of labels and results are different!"
...
def test_scores(data):
    ...
    assert scores.shape[0] == y_test.shape[0], f"The number of labels and scores are different!"
